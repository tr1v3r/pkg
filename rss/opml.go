...
func (a OutlineArray) Append(groupText, groupTitle string, o *Outline) OutlineArray {
	if o.Text == "" || o.XMLUrl == "" { // invalid outline
		return a
	}
	if groupText == "" || groupTitle == "" { // group info cannot be empty
		return a
	}
	...
	return append(a, &Outline{Text: groupText, Title: groupTitle, Outlines: []*Outline{o}})
}
